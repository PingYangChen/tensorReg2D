#'
#' @title The tensorReg2D Package
#'
#' @description \kbd{tensorReg2D} is a tool used to fit second-order tensor type data.
#'
#' @details
...
#'
#' For a complete list of functions, use \kbd{help(package = tensorReg2D)}.
#'
#' @docType package
#'
#' @author
